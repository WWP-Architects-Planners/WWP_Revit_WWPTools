...
def _show_sheet_scale_dialog(
    ...
    search_box.TextChanged += EventHandler(_on_search_changed)
    sheets_list.SelectionChanged += EventHandler(_on_selection_changed)
    ok_button.Click += EventHandler(_on_ok)
